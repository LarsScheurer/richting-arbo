// Centrale definitie van hoofdstukken voor organisatie analyse
export const ORGANISATIE_ANALYSE_HOOFDSTUKKEN: {[key: string]: string} = {
...
// Array versie voor progress steps
export const ORGANISATIE_ANALYSE_HOOFDSTUKKEN_ARRAY = [
  "Introductie en Branche-identificatie",
