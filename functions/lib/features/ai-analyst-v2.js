...
exports.analyseBedrijfV2 = void 0;
...
exports.analyseBedrijfV2 = (0, https_1.onCall)({ region: LOCATION, timeoutSeconds: 540, memory: "1GiB", cors: true }, async (request) => {
    var _a, _b, _c, _d, _e, _f;
    const { companyName, websiteUrl } = request.data;
    if (!companyName || !websiteUrl)
        throw new https_1.HttpsError("invalid-argument", "Geen input: companyName en websiteUrl vereist");
    if (!PROJECT_ID)
  ...
  "metadata": {
    ...
    try {
        ...
        const modelWithSystem = vertexAI.getGenerativeModel({
            ...
            safetySettings: [
                { category: vertexai_1.HarmCategory.HARM_CATEGORY_HATE_SPEECH, threshold: vertexai_1.HarmBlockThreshold.BLOCK_NONE },
                { category: vertexai_1.HarmCategory.HARM_CATEGORY_DANGEROUS_CONTENT, threshold: vertexai_1.HarmBlockThreshold.BLOCK_NONE },
                { category: vertexai_1.HarmCategory.HARM_CATEGORY_SEXUALLY_EXPLICIT, threshold: vertexai_1.HarmBlockThreshold.BLOCK_NONE },
                { category: vertexai_1.HarmCategory.HARM_CATEGORY_HARASSMENT, threshold: vertexai_1.HarmBlockThreshold.BLOCK_NONE }
            ]
        });
...
//# sourceMappingURL=ai-analyst-v2.js.map